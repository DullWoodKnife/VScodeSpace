...
测试网址：http://httpbin.org/user-agent

ua网址：https://useragentstring.com/pages/useragentstring.php?typ=Browser
...
* **启动所有爬虫**
* 启动redis-shell  cd到根目录，输入redis-cli.exe
